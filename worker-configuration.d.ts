/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ecf3e86b41b8bc7afe8b9af72e13ed34)
...
interface __BaseEnv_Env {
	...
	ACCESS_AUD: "";
	WORKSPACE_DOMAIN: "";
	OPEN_TRACKING_ORIGIN: "";
	SUPPORT_AGENT: DurableObjectNamespace<import("./src/worker/entry").SupportDraftAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/entry");
		durableNamespaces: "SupportDraftAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "OWNER_EMAIL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "WORKSPACE_DOMAIN" | "OPEN_TRACKING_ORIGIN">> {}
}
